 ...
 * @param {string} version - Version string like "5.1.3-OS10"
 ...
 * @returns {string} - Next version like "5.1.3-OS11"
 */
...
async function getCommitsSinceLastTag() {
  try {
    ...
    // Example: 5.1.3-OS10, 5.1.3-OS11, etc.
