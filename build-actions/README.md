...
- iOS specific. Adds multiple a `CFBundleLocalizations` entry with multiple language codes to the app's Info.plist file. These are necessary for the Calendar Plugin to work properly.
